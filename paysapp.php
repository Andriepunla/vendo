...
<body>
  ...
  <div>
  <img src="top25animecharacters-blogroll-1660777571580.jpg" style="width: <?php echo $ImageRangeSize . '%'; ?>;border-color: <?php echo $border; ?>;border-width: 4px; border-style: solid;">
  </div>
